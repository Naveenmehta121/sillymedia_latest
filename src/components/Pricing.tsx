...
const Pricing = () => {
  ...
  const gridReveal = useStaggerReveal({ threshold: 0.05 }); // Growth expanded by default
  ...
  return (
    <section id="pricing" className="py-20 bg-gradient-to-br from-black via-purple-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={gridReveal.ref} className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {plans.map((plan, index) => {
            ...
            return (
              <div
                ...
                className={`relative transform transition-all duration-500 ${isHovered
                    ? plan.popular
                      ? 'scale-[1.05] z-10 drop-shadow-[0_0_30px_rgba(168,85,247,0.4)]'
                      : 'scale-[1.03] z-10'
                    : plan.popular
                      ? 'md:scale-[1.02]'
                      : ''
              ...
              >
                ...
                <div className={`h-full relative overflow-hidden backdrop-blur-sm border-2 rounded-3xl p-8 transition-all duration-500 flex flex-col ${plan.popular
                  ? isHovered
                    ? 'border-purple-400/80 bg-white/15 shadow-[0_0_40px_rgba(168,85,247,0.3)]'
                    : 'border-purple-500/50 bg-white/10'
                  : isHovered
                    ? 'border-purple-500/50 bg-white/10'
                    : 'border-white/20 bg-gradient-to-br from-white/10 to-white/5 hover:border-purple-500/50'
                  }`}>
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${index === 0 ? 'rgba(59,130,246,0.15), rgba(6,182,212,0.1)' :
                        index === 1 ? 'rgba(168,85,247,0.2), rgba(236,72,153,0.15)' :
                          'rgba(249,115,22,0.15), rgba(239,68,68,0.1)'
                        })`,
                      opacity: isHovered ? 1 : plan.popular ? 0.7 : 0,
                    }}
                  />

                  {/* Glow Effect */}
                  <div
                    className="absolute inset-0 rounded-3xl filter blur-xl transition-opacity duration-500 pointer-events-none"
                    style={{
                      background: `linear-gradient(135deg, ${index === 0 ? 'rgba(59,130,246,0.3), rgba(6,182,212,0.2)' :
                        index === 1 ? 'rgba(168,85,247,0.3), rgba(236,72,153,0.2)' :
                          'rgba(249,115,22,0.3), rgba(239,68,68,0.2)'
                        })`,
                      opacity: isHovered ? 0.4 : plan.popular ? 0.2 : 0,
                    }}
                  />
